...
class App {
  constructor(documentRef, storageRef = sessionStorage, webhookUrl = null, collectionNameInputId = 'data_collection_name', consoleLog = null) {
    ...
    this.log = consoleLog ? consoleLog : null;
  }
